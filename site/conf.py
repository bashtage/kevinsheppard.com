...
BLOG_AUTHOR = "Kevin Sheppard"  # (translatable)
BLOG_TITLE = "Kevin Sheppard"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.kevinsheppard.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.kevinsheppard.com/"
BLOG_EMAIL = "kevin.k.sheppard@gmail.com"
BLOG_DESCRIPTION = "Kevin Sheppard's Website"  # (translatable)
        ...
        (
            (
                ...
                (
                    ...
                    '<span><i class="fab fa-github"></i> arch</span>',
                ),
                (
                    "https://github.com/bashtage/linearmodels",
                    '<span><i class="fab fa-github"></i> linearmodels</span>',
                ),
                (
...
# Default is:
FILES_FOLDERS = {"files": "files", "icons": ""}
...
LICENSE = """
Content licensed <a rel="license" href="https://creativecommons.org/licenses/by-nc-nd/4.0/">CC-BY-NC-ND</a>
except code blocks which are <a rel="license" href="https://opensource.org/licenses/NCSA/">NCSA</a> licensed.
"""

# A small copyright notice for the page footer (in HTML).
# (translatable)
CONTENT_FOOTER = (
    '<p> &copy; {date}         <a href="mailto:{email}">{author}</a> - {license} </p>'
)
...
# is in the manual.
COMMENT_SYSTEM_ID = "kevin-sheppard"
...
def count_tags(posts):
    ...
    tag_counts = [{"tag": tag, "count": count} for tag, count in count_tags.items()]
    cat_counts = [
        {"category": cat, "count": count} for cat, count in count_cats.items()
    ]

    return tag_counts, cat_counts


GLOBAL_CONTEXT = {"galleries": generate_index.galleries, "count_tags": count_tags}
